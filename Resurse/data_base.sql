...
('Vioara 4/4 Stentor Student', 'Vioara cu sunet clar și calitate, perfectă pentru studenți.','vioara-electrica.jpg', 'vioara','instrument cu coarde', 599.00, 2.3, 'incepator', '{"lemn", "carbon", "fildeș"}', true),
...
('Chitară electrică Fender Stratocaster', 'Chitară electrică iconică, cu sunet puternic și ușor de cântat.','chitara-electrica.jpg', 'chitara','instrument cu coarde', 1999.00, 4.5, 'mediu', '{"lemn", "metal"}', true),
...
('Chitara clasica Valencia CG160', 'Chitara clasica cu corp din lemn de artar, finisaj lucios, tastiera din lemn de trandafir și corzi de nylon. Are sunet cald și clar.', 'chitara-clasica.jpg', 'chitara', 'instrument cu coarde', 250.00, 2.1, 'incepator', '{"lemn"}', false),
...
('Vioara Stentor Student II', 'Vioară pentru studenți, cu corp din lemn de artar, finisaj lucios, tastieră din lemn de ebonită și corzi Pirastro. Vine cu husă și arc.', 'vioara-clasica.jpg', 'vioara', 'instrument cu coarde', 300.00, 0.5, 'incepator', '{"lemn"}', true),
...
('Chitară bas Fender Player Series Precision Bass', 'Bas electric cu 4 corzi, două split single coil pickups, buton de ton și două de volum.','chitara-bas.jpg', 'chitara','instrument cu coarde', 999.00, 4.50, 'mediu', '{"lemn", "metal"}', true),
