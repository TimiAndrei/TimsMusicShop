...
class AccesBD {
    static #instanta = null;  //pentru design pattern singletone 
    ...
    select({ tabel = "", campuri = [], conditiiAnd = [] } = {}, callback, parametriQuery = []) {
        ...
        //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        // bonus: in conditiiWhere ii dau vector de vector cu and intre ele si or intre vectori
        /*
    ...
    insert({ tabel = "", campuri = {} } = {}, callback) {
        //ex: campuri = { nume: 'ionel', prenume: 'ion', email: 'ionel@gmail'}
        console.log("-------------------------------------------")
        ...
        // map itereaza prin toate elementele si returneaza un nou array cu elementele transformate
        console.log(comanda);
